...
public class ExampleDaoGenerator {
    ...
    public static void main(String[] args) throws Exception {
        Schema schema = new Schema(1000, "com.tanlifei.download.entity.test");
        //addNote(schema);
        //addCustomerOrder(schema);
        addDownload(schema);
        new DaoGenerator().generateAll(schema, "/Users/tanlifei/Documents/WorkSpace/Project/Studio/Self/Download-master/download/src/main/java");
    }
