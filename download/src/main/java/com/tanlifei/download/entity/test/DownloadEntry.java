...
public class DownloadEntry implements Serializable{
    ...
    public DownloadEntry(String url, String name, Integer currentLength, Integer totalLength, Integer status, Integer percent, Boolean isSupportRange, Integer range_0, Integer range_1, Integer range_2) {
        this.url = url;
        this.name = name;
